...
# classify_impact 는 substring 매칭(`kw in title`)이므로 키워드는 generic 하게 둔다.
# 예: "유상증자결정" 으로 두면 "(제3자배정)" / "(주주배정)" 모두 잡힘.
URGENT_KEYWORDS = (
    "조회공시", "거래정지", "관리종목", "감사의견거절", "소송", "회생절차",
    "상장폐지", "영업정지", "배임",
)
POSITIVE_KEYWORDS = (
    "단일판매ㆍ공급계약체결", "자기주식취득", "무상증자", "현금ㆍ현물배당", "특허취득",
    "주식배당결정", "액면분할", "주식분할", "자기주식소각",
)
NEGATIVE_KEYWORDS = (
    "감사의견거절", "관리종목", "유상증자결정", "전환사채권발행", "소송", "횡령",
    "무상감자", "감자결정", "영업정지", "상장폐지", "배임", "회생절차",
    "신주인수권부사채", "교환사채",
)
