...
class KisRealtimeSubscriptionManagerTest {
    ...
    @Mock RemoteKisUpstreamClient remoteUpstreamClient;
    ...
    void subscribeOnFirstSession() {
        // given
        KisRealtimeSubscriptionManager manager = new KisRealtimeSubscriptionManager(new ObjectMapper(), upstreamClient, remoteUpstreamClient);
        ...
        // when
        manager.register(firstSession, TEST_USER_ID, key);
    ...
    void doNotSubscribeAgainForSameKey() {
        ...
        // when
        manager.register(firstSession, TEST_USER_ID, key);
        manager.register(secondSession, TEST_USER_ID, key);
