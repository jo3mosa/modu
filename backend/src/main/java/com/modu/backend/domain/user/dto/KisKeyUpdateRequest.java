...
public record KisKeyUpdateRequest(
        ...
        @Schema(description = "변경할 HTS ID (null이면 기존 값 유지)", example = "myhts01", nullable = true)
        @NullOrNotBlank
        String htsId,
    ...
    public boolean isAnyFieldProvided() {
        return appKey != null || appSecret != null || htsId != null || accountNo != null || isRealAccount != null;
    }
}
